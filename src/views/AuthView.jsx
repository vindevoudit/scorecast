  ...
  if (authView === 'reset') {
    ...
    body = (
      <div className="mx-auto w-full max-w-6xl py-6">
        ...
        {/* Tier 30 Phase 2 follow-up — ambient side panel removed at user
            request; layout reverts to the pre-Phase-2 side-by-side login
            + register grid on lg+ (stacked below). */}
