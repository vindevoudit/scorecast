...
| Area                         | Issue                                                                                                                                                                                                                                                                    | Tier                      |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- |
| Tests                        | Playwright E2E covers three happy paths (register→pick→result, group lifecycle, comment+reaction). No unit / integration tests below the E2E layer yet                                                                                                                   | future                    |
